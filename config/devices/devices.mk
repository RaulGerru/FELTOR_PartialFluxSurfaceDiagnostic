...
CFLAGS+=-x c++ -DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_CPP #-Wdeprecated-declarations -Wunused-private-field -Wunused-lambda-capture -Wmismatched-tags -Winconsistent-missing-override -Wunknown-attributes -Wshift-negative-value
#INCLUDE+= -march=native #armv8-a+fp+simd+crypto+crc #FOR CORRECTING THE VCL LIBRARY
LIBS=-L/opt/homebrew/Cellar/netcdf/4.8.1_2/lib -lnetcdf -L/opt/homebrew/Cellar/hdf5/1.12.1_1/lib -lhdf5 -lhdf5_hl
